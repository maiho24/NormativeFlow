...
from .coupling_layer import ConditionalCouplingLayer, AdaptiveConditionalCouplingLayer
...
class ConditionalRealNVP(nn.Module):
    def __init__(self, 
        ...
        # Initialise transformation layer if enabled
        ...
        """
        self.layers = nn.ModuleList([
            AdaptiveConditionalCouplingLayer(
                input_dim=input_dim,
                hidden_dims=hidden_dims,
                covariate_net_dims=covariate_net_dims,
                c_dim=c_dim,
